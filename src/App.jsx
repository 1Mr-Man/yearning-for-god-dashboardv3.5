...
const ContentResearch = lazy(() => import('./tabs/ContentResearch'))
const AssetLibrary = lazy(() => import('./tabs/AssetLibrary'))
const BookLibrary = lazy(() => import('./tabs/BookLibrary'))
...
{activeTab === 'content-research' && <ContentResearch ctx={{ supabase, styles }} />}
{activeTab === 'asset-library' && <AssetLibrary ctx={{ supabase, styles }} />}
{activeTab === 'book-journey' && <BookLibrary ctx={{ supabase, styles }} />}
 </Suspense>
 </div>
 )
}